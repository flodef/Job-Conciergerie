...
export default function Logo({ size = 40, className = '' }: LogoProps) {
  return (
    ...
    >
      ...
      {/* House roof */}
      <path d="M32 10L52 26V28H12V26L32 10Z" fill="url(#logo-grad)" />
      ...
      <g>
        {/* Bell dome */}
        <path d="M32 14C29.5 14 27.5 15.8 27.5 18.2V21H36.5V18.2C36.5 15.8 34.5 14 32 14Z" fill="url(#logo-grad)" />
        {/* Bell base line */}
      ...
      {/* Sparkles */}
      <g>
        <path d="M50 16L51.2 19.2L54.4 20.4L51.2 21.6L50 24.8L48.8 21.6L45.6 20.4L48.8 19.2L50 16Z" fill="#2DD4BF" />
        <path
