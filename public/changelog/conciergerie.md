...
- **Amélioration filtres calendrier** : ajout du filtre "Expirée" pour voir les missions non acceptées qui ont dépassé leur date de fin sans être terminées
...
- **Filtres missions** : nouveau filtre **Prestataire** pour filtrer vos missions par prestataire, plus facilement
- **Filtres missions (prestataires)** : vos prestataires peuvent désormais filtrer par mois — utile pour leur compta et pour savoir les factures à vous envoyer
